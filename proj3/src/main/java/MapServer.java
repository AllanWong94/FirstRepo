...
public class MapServer {
    ...
    public static Map<String, Object> getMapRaster(Map<String, Double> params, OutputStream os) {
        ...
        System.out.println("ullon="+(params.get("ullon")-ROOT_ULLON));
        System.out.println("ullat="+(params.get("ullat")-ROOT_ULLAT));
        System.out.println("lrlon="+(params.get("lrlon")-ROOT_LRLON));
        System.out.println("lrlat="+(params.get("lrlat")-ROOT_LRLAT));
        System.out.println("w="+params.get("w"));
        System.out.println("h="+params.get("h"));*/
        ts.findTiles(ullon,ullat,lrlon,lrlat,w,h);
        ts.drawJoinedBufferedImage(os);
        rasteredImageParams.put("raster_ul_lon", ts.getRasteredImageUlLon());
        rasteredImageParams.put("raster_ul_lat", ts.getRasteredImageUlLat());
        rasteredImageParams.put("raster_lr_lon", ts.getRasteredImageLrLon());
        rasteredImageParams.put("raster_lr_lat", ts.getRasteredImageLrLat());
        rasteredImageParams.put("raster_width", ts.getRasteredImageWidth());
        rasteredImageParams.put("raster_height", ts.getRasteredImageHeight());
        rasteredImageParams.put("depth", ts.getTcDepth());
        rasteredImageParams.put("query_success", ts.isTcInitialized());
        /*System.out.println("rasteredImageParams parameters:");
        System.out.println("ullon="+((double)rasteredImageParams.get("raster_ul_lon")-ROOT_ULLON));
        System.out.println("ullat="+((double)rasteredImageParams.get("raster_ul_lat")-ROOT_ULLAT));
        System.out.println("lrlon="+((double)rasteredImageParams.get("raster_lr_lon")-ROOT_LRLON));
        System.out.println("lrlat="+((double)rasteredImageParams.get("raster_lr_lat")-ROOT_LRLAT));
        System.out.println("w="+rasteredImageParams.get("raster_width"));
        System.out.println("h="+rasteredImageParams.get("raster_height"));
        System.out.println("depth="+rasteredImageParams.get("depth"));*/
    ...
    //REQUIRED_ROUTE_REQUEST_PARAMS = {"start_lat", "start_lon",
     //   "end_lat", "end_lon"};
    public static LinkedList<Long> findAndSetRoute(Map<String, Double> params) {
        ...
        LinkedList<Long> routeID=new LinkedList<>();
        LinkedList<Node> routeNodes=new LinkedList<>();
        Route route=new Route(g,g.maphandler);
        route.setStartEnd(startLon,startLat,endLon,endLat);
        routeID=route.route();
        routeNodes=route.getNodes();
        ts.setNodes(routeNodes);
        return routeID;
    }
