...
var centerlat=(params["ullat"]+params["lrlat"])/2;
var centerlon=(params["ullon"]+params["lrlon"])/2;
// Compute lat and lon by window size
function Myreal_ullon() {
var temp=(params["ullon"]+params["lrlon"])/2 - wdpp * params["w"]/2;
if(temp<minUllon){
temp=minUllon;
}
return  temp}
function Myreal_ullat() {
var temp=(params["ullat"]+params["lrlat"])/2 + hdpp * params["h"]/2;
if(temp>maxUllat){
temp=maxUllat;
}
return  temp}
function Myreal_lrlon() {
var temp=(params["ullon"]+params["lrlon"])/2 + wdpp * params["w"]/2;
if(temp>maxLrlon){
temp=maxLrlon;
}
return  temp}
function Myreal_lrlat() {
var temp=(params["ullat"]+params["lrlat"])/2 - hdpp * params["h"]/2;
if(temp<minLrlat){
temp=minLrlat;
}
...
$( document ).ready(function() {
    ...
    params["ullon"] = Myreal_ullon();
    params["ullat"] = Myreal_ullat();
    params["lrlon"] = Myreal_lrlon();
    params["lrlat"] = Myreal_lrlat();
    update();
    var $body = $('#mapbody');
